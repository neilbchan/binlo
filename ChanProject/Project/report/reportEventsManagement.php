<?php
	...
	$queryInstructor = "SELECT * FROM instructor WHERE instructor_course = 'EventsManagement'and users_id = ".$users_id;
  	$resultInstructor = mysqli_query($conn, $queryInstructor);
  	$allInstructor = mysqli_fetch_array($resultInstructor);

	$queryTraining = "SELECT * FROM training WHERE training_course = 'EventsManagement'and users_id = ".$users_id;
  	$resultTraining = mysqli_query($conn, $queryTraining);
  	$allTraining = mysqli_fetch_array($resultTraining);

	$queryCenter = "SELECT * FROM center WHERE center_course = 'EventsManagement'and users_id = ".$users_id;
