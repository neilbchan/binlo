    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="report/reportMobileDevelopment.php">Report</a>
                </li>
                <li>
        ...
        <div id="content">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                    ...
                    <a href="form\instructor.php?course=<?php echo "MobileDevelopment";?>"><img src="images/instructortwo.png" alt="IMG" width="90%" style="margin-right: 50px; margin-top: 35px"></a>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 text-center">   
                    ...
                    <a href="form\training.php?course=<?php echo "MobileDevelopment";?>"><img src="images/training.png" alt="IMG" width="90%" style="margin-right: 50px; margin-top: 35px"></a>
                    <div class="card-body text-center">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 text-center">    
                    ...
                    <a href="form\center.php?course=<?php echo "MobileDevelopment";?>"><img src="images/image.png" alt="IMG" width="90%" style="margin-top: 35px"></a> 
                    <div class="card-body text-center">
